...
export const flagInfo = {
    0: {
        ...
        "NT_race_mode":                   { name: "Race Mode", tooltip: "Introduces a timer that pauses while waiting for the boss, allowing players to race to the end." }, 
...
export const defaultFlags = {
    ...
    0: [
        ...
        { id: "NT_race_mode",                  type: "boolean", value: false  },
